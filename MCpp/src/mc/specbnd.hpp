...
& \left(\begin{array}{l} [\underline{\partial_{x_1}f}:\overline{\partial_{x_1}f}]\\ [\underline{\partial_{x_2}f}:\overline{\partial_{x_2}f}]\\ [\underline{\partial_{x_3}f}:\overline{\partial_{x_3}f}]\end{array}\right)
\f}
